...
//
//     final technology = technologyFromJson(jsonString);

import 'dart:convert';

Technology technologyFromJson(String str) =>
    Technology.fromJson(json.decode(str));

String technologyToJson(Technology data) => json.encode(data.toJson());
...
enum SourceId { DETIK, LIPUTAN6, SINDONEWS }

final sourceIdValues = EnumValues({
  "detik": SourceId.DETIK,
  "liputan6": SourceId.LIPUTAN6,
  "sindonews": SourceId.SINDONEWS
});

enum SourceName { DETIK, LIPUTAN6, SINDONEWS }

final sourceNameValues = EnumValues({
  "Detik": SourceName.DETIK,
  "Liputan6": SourceName.LIPUTAN6,
